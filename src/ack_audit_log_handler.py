...
def _parse_time(time_str: str) -> int:
    ...
    try:
        ...
        if "timezone information" in str(e):
            raise e
        raise ValueError(f"Invalid time format: {time_str}. Expected ISO 8601 format (e.g., 2025-09-16T08:09:44Z) or Unix timestamp.")
...
class ACKAuditLogHandler:
    ...
    def _register_tools(self):
        ...
        async def query_audit_logs(
                ...
                start_time: Optional[str] = Field(None, description="查询开始时间，格式为 ISO 8601 (如: 2025-09-16T08:09:44Z)"),
                end_time: Optional[str] = Field(None, description="查询结束时间，格式为 ISO 8601 (如: 2025-09-16T08:09:44Z)"),
        ...
        async def get_current_time() -> GetCurrentTimeOutput:
            """获取当前时间

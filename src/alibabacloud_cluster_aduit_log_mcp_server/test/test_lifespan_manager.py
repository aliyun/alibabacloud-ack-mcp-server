...
class TestSimpleKubeAuditLifespanManager:
    ...
    @patch(
        "alibabacloud_cluster_aduit_log_mcp_server.provider.provider.AlibabaSLSProvider"
    )
            ...
            "clusters": [
                {
                    ...
                    "provider": {"name": "unknown-provider", "config": {}},
                }
            ]
        }
    ...
    def test_initialize_providers_missing_cluster_name(self, mock_config):
        ...
        config = {
            "clusters": [{"provider": {"name": "alibaba-sls", "alibaba_sls": {}}}]
        }
    ...
    def test_initialize_providers_missing_provider_name(self, mock_config):
        ...
        config = {
            "clusters": [{"name": "test-cluster", "provider": {"alibaba_sls": {}}}]
        }
    ...
    def test_lifespan_manager_inheritance(self):
        ...
        from alibabacloud_cluster_aduit_log_mcp_server.utils.context import (
            LifespanManager,
        )

...
class ACKNodePoolManagementRuntimeProvider(RuntimeProvider):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info(f"ACKNodePoolManagementRuntimeProvider initialized with region: {self.config.get('region_id')}")
    ...
    def initialize_providers(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 对齐 ack-cluster-management 的 AK 传入方式
            ...
            # Initialize nodepool management capabilities
            providers["nodepool_management_capabilities"] = {
                "type": "ack_nodepool_management",
                "supported_operations": [
                    "describe_cluster_node_pools",
                    "describe_cluster_node_pool_detail",
                    "create_cluster_node_pool", 
                    "modify_cluster_node_pool",
                    "scale_cluster_node_pool",
                    "remove_node_pool_nodes",
                    "delete_cluster_node_pool",
                    "upgrade_cluster_nodepool",
                    "attach_instances_to_node_pool"
                ],
                "region": region,
            ...
            logger.info(f"ACK nodepool management providers initialized successfully for region: {region}")

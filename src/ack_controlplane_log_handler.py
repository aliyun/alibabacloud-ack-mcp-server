...
def _parse_time(time_str: str) -> int:
    ...
    try:
        ...
        if "timezone information" in str(e):
            raise e
        raise ValueError(f"Invalid time format: {time_str}. Expected ISO 8601 format (e.g., 2025-09-16T08:09:44Z), relative time (e.g., 24h), or Unix timestamp.")
...
class ACKControlPlaneLogHandler:
    ...
    def _register_tools(self):
        """Register control plane log related tools."""
        ...
        async def query_controlplane_logs(
                ...
                start_time: Optional[str] = Field("24h", description="查询开始时间，支持格式为 ISO 8601 (如: 2025-09-16T08:09:44Z)"),
                end_time: Optional[str] = Field(None, description="查询结束时间，支持格式为 ISO 8601 (如: 2025-09-16T08:09:44Z)"),
            ...
            try:
                ...
                try:
                    ...
                    logger.info(f"Control plane logging enabled for cluster {cluster_id}, available components: {controlplane_config.components}")

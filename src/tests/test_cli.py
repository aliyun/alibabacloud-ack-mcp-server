...
class TestCLIRunner:
    ...
    def test_list_tools_contains_all_tools(self, capsys):
        ...
        captured = capsys.readouterr()
        expected = [
            "list_clusters", "ack_kubectl", "query_prometheus",
            "query_prometheus_metric_guidance", "diagnose_resource",
            "query_inspect_report", "query_audit_log", "get_current_time",
...
class TestBuildSettingsDict:
    ...
    def test_default_values(self):
        ...
        args = argparse.Namespace(
            allow_write=False, region=None, access_key_id=None,
            access_key_secret=None, kubeconfig_mode=None, kubeconfig_path=None,
        )
    ...
    def test_cli_args_override(self):
        import argparse
        args = argparse.Namespace(
            allow_write=True, region="us-west-1", access_key_id="AK",
            access_key_secret="SK", kubeconfig_mode="LOCAL",

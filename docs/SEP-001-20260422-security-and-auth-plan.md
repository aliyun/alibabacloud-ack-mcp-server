...
| 受保护资源元数据 (RFC 9728) | MUST* | ✅ 已完成 | Phase 1 |
| 授权服务器发现 (RFC 8414) | MUST* | ✅ 已完成 | Phase 1 |
| Bearer Token 验证 | MUST* | ✅ 已完成 | Phase 1 |
| WWW-Authenticate 头响应 | MUST* | ✅ 已完成 | Phase 1 |
| PKCE 支持 | MUST* | ✅ 已完成 | Phase 1 |
...
### Phase 1: 基础 OAuth 2.1 资源服务器（优先级：高） — ✅ 已完成
...
| 2026-04-22 | v1.1 | Phase 1 完成 — 实现基础 OAuth 2.1 资源服务器（RemoteAuthProvider + JWTVerifier） |
